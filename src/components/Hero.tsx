...
//   return (
//     <section className="relative container mx-auto px-6 pt-32 pb-20 text-center bg-brandBlack text-brandWhite overflow-hidden">
...
//         className="text-lg text-gray-300 mb-4 relative z-10"
//       >
...
//         className="text-6xl font-extrabold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-400 relative z-10"
//       >
//         Aviral Yadav
//       </motion.h1>
...
//         className="text-lg text-gray-300 max-w-2xl mx-auto mb-10 relative z-10"
//       >
//         I build impactful digital experiences — from websites and apps to AI-powered tools, creative campaigns, and more.
//       </motion.p>
...
//         className="flex flex-wrap justify-center gap-4 max-w-3xl mx-auto relative z-10"
//       >
